...
int pipeline_hls(struct halide_buffer_t *_p2_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS {
 ...
 if (_28)
 {
  ...
  struct halide_buffer_t *_34 = _halide_buffer_init(_output_buffer, _29, _31, _30, _32, 1, 32, 2, _33, _30);
  (void)_34;
 } // if _28
 ...
 if (_35)
 {
  ...
  struct halide_buffer_t *_43 = _halide_buffer_init(_p2_input_buffer, _36, _38, _37, _39, 1, 32, 2, _42, _37);
  (void)_43;
 } // if _35
 ...
 if (_47)
 {
  ...
  int32_t _242 = max(_240, _241);
  {
   ...
   if ((_248 > ((int64_t(1) << 31) - 1)) || ((_248 * sizeof(uint32_t )) > ((int64_t(1) << 31) - 1)))
   {
    halide_error(_ucon, "32-bit signed overflow computing size of allocation hw_input\n");
    return -1;
   } // overflow test hw_input
   int64_t _249 = _248;
   uint32_t *_hw_input = (uint32_t  *)halide_malloc(_ucon, sizeof(uint32_t )*_249);
   if (!_hw_input)
   {
   ...
   struct halide_buffer_t *_259 = _halide_buffer_init(_250, _255, _hw_input, _256, _257, 1, 32, 2, _258, _256);
   ...
   for (int _hw_input_s0_y = _15; _hw_input_s0_y < _15 + _260; _hw_input_s0_y++)
   {
    ...
    for (int _hw_input_s0_x = _12; _hw_input_s0_x < _12 + _261; _hw_input_s0_x++)
    {
     ...
     uint32_t _267 = ((const uint32_t *)_p2_input)[_266];
   ...
   // consume hw_input
   {
    int32_t _274 = max(_13, 1918);
    int64_t _275 = _274;
    int32_t _276 = max(_16, 1078);
    int64_t _277 = _275 * _276;
    if ((_277 > ((int64_t(1) << 31) - 1)) || ((_277 * sizeof(uint32_t )) > ((int64_t(1) << 31) - 1)))
    {
     halide_error(_ucon, "32-bit signed overflow computing size of allocation hw_output\n");
     return -1;
    } // overflow test hw_output
    int64_t _278 = _277;
    uint32_t *_hw_output = (uint32_t  *)halide_malloc(_ucon, sizeof(uint32_t )*_278);
    if (!_hw_output)
    {
     return halide_error_out_of_memory(_ucon);
    }
    ...
    int32_t _280 = max(_13, 1918);
    int32_t _281 = max(_16, 1078);
    struct {
     const int32_t f_0;
     const int32_t f_1;
     const int32_t f_2;
    ...
    struct halide_buffer_t *_286 = _halide_buffer_init(_279, _282, _hw_output, _283, _284, 1, 32, 2, _285, _283);
    struct halide_buffer_t * _hw_output_buffer = _286;
    // produce hw_output
    int32_t _287 = _16 + 1077;
    int32_t _288 = _287 / 1078;
    int32_t _289 = _288 * 1078;
    int32_t _290 = _287 - _289;
    int32_t _291 = _290 >> 31;
    int32_t _292 = 1078 >> 31;
    ...
    {
     int32_t _298 = _hw_output_s0_y_yo * 1078;
     int32_t _299 = _298 + _15;
     int32_t _300 = _15 + _16;
     int32_t _301 = _300 + -1078;
     int32_t _302 = min(_299, _301);
     int32_t _303 = _13 + 1917;
     int32_t _304 = _303 / 1918;
     int32_t _305 = _304 * 1918;
     int32_t _306 = _303 - _305;
     int32_t _307 = _306 >> 31;
     int32_t _308 = 1918 >> 31;
     ...
     {
      int32_t _314 = _hw_output_s0_x_xo * 1918;
      int32_t _315 = _314 + _12;
      int32_t _316 = _12 + _13;
      int32_t _317 = _316 + -1918;
      int32_t _318 = min(_315, _317);
      hls::stream<AxiPackedStencil<uint32_t, 1, 1> > _hw_input_stencil_update_stream;
      ...
      void *_325 = ((uint32_t *)_hw_input + _324);
      subimage_to_stream(_hw_input_buffer, _hw_input_stencil_update_stream, _325, 1, 1920, _322, 1080);
      (void)0;
      hls::stream<AxiPackedStencil<uint32_t, 1, 1> > _hw_output_stencil_stream;
      hls_target(_hw_input_stencil_update_stream, _hw_output_stencil_stream);
      int32_t _401 = max(_13, 1918);
      int32_t _402 = _320 * _401;
      int32_t _403 = _319 + _402;
      void *_404 = ((uint32_t *)_hw_output + _403);
      stream_to_subimage(_hw_output_buffer, _hw_output_stencil_stream, _404, 1, 1918, _401, 1078);
      (void)0;
    ...
    for (int _output_s0_y = _15; _output_s0_y < _15 + _16; _output_s0_y++)
    {
     ...
     {
      int32_t _405 = _output_s0_x - _223;
      int32_t _406 = _output_s0_y - _201;
      int32_t _407 = max(_13, 1918);
      int32_t _408 = _406 * _407;
      int32_t _409 = _405 + _408;
      uint32_t _410 = _hw_output[_409];
      int32_t _411 = _output_s0_y * _17;
      int32_t _412 = _output_s0_x + _411;
      int32_t _413 = _15 * _17;
      int32_t _414 = _12 + _413;
      int32_t _415 = _412 - _414;
      ((uint32_t *)_output)[_415] = _410;
     } // for _output_s0_x
    } // for _output_s0_y
...
int pipeline_hls(struct buffer_t *_p2_input, struct buffer_t *_output) HALIDE_FUNCTION_ATTRS {
 ...
 struct halide_dimension_t *_416 = (struct halide_dimension_t *)(&s6);
 struct halide_dimension_t * _t345 = _416;
 halide_buffer_t b3;
 struct halide_buffer_t *_417 = &b3;
 uint64_t _418 = (uint64_t)(0);
 void *_419 = (void *)(_418);
 struct halide_device_interface_t *_420 = (struct halide_device_interface_t *)(_418);
 struct halide_buffer_t *_421 = _halide_buffer_init(_417, _t345, _419, _418, _420, 1, 32, 2, _t345, _418);
 struct halide_buffer_t * _p2_input_upgraded = _421;
 struct {
  const int32_t f_0;
  const int32_t f_1;
  const int32_t f_2;
 ...
 struct halide_dimension_t *_422 = (struct halide_dimension_t *)(&s7);
 struct halide_dimension_t * _t349 = _422;
 halide_buffer_t b4;
 struct halide_buffer_t *_423 = &b4;
 struct halide_buffer_t *_424 = _halide_buffer_init(_423, _t349, _419, _418, _420, 1, 32, 2, _t349, _418);
 struct halide_buffer_t * _output_upgraded = _424;
 int32_t _425 = halide_upgrade_buffer_t(_ucon, "p2:input", _p2_input, _p2_input_upgraded);
 bool _426 = _425 == 0;
 if (!_426)  {
  return _425;
 }
 int32_t _427 = halide_upgrade_buffer_t(_ucon, "output", _output, _output_upgraded);
 bool _428 = _427 == 0;
 if (!_428)  {
  return _427;
 }
 int32_t _429 = pipeline_hls(_p2_input_upgraded, _output_upgraded);
 bool _430 = _429 == 0;
 if (!_430)  {
  return _429;
 }
 bool _431 = _halide_buffer_is_bounds_query(_p2_input_upgraded);
 if (_431)
 {
  int32_t _432 = halide_downgrade_buffer_t(_ucon, "p2:input", _p2_input_upgraded, _p2_input);
  bool _433 = _432 == 0;
  if (!_433)   {
   return _432;
  }
 ...
 {
  int32_t _434 = halide_downgrade_buffer_t_device_fields(_ucon, "p2:input", _p2_input_upgraded, _p2_input);
  bool _435 = _434 == 0;
  if (!_435)   {
   return _434;
  }
 } // if _431 else
 bool _436 = _halide_buffer_is_bounds_query(_output_upgraded);
 if (_436)
 {
  int32_t _437 = halide_downgrade_buffer_t(_ucon, "output", _output_upgraded, _output);
  bool _438 = _437 == 0;
  if (!_438)   {
   return _437;
  }
 ...
 {
  int32_t _439 = halide_downgrade_buffer_t_device_fields(_ucon, "output", _output_upgraded, _output);
  bool _440 = _439 == 0;
  if (!_440)   {
   return _439;
  }
