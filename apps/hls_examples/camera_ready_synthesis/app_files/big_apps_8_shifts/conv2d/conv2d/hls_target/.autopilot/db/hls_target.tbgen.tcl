set C_TypeInfoList {{ 
"hls_target" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"hw_input": [[], {"reference": "0"}] }, {"hw_output": [[], {"reference": "1"}] }],[],""], 
"1": [ "stream<AxiPackedStencil<unsigned char, 1, 1, 1, 1> >", {"hls_type": {"stream": [[[[],"2"]],"3"]}}], 
"2": [ "AxiPackedStencil<unsigned char, 1, 1, 1, 1>", {"struct": [[],[{"T":[[], {"scalar": "unsigned char"}]},{"EXTENT_0":[[], {"scalar": { "long unsigned int": 1}}]},{"EXTENT_1":[[], {"scalar": { "long unsigned int": 1}}]},{"EXTENT_2":[[], {"scalar": { "long unsigned int": 1}}]},{"EXTENT_3":[[], {"scalar": { "long unsigned int": 1}}]}],[{ "value": [[], "4"]},{ "last": [[], "5"]}],""]}], 
"4": [ "ap_uint<8>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 8}}]],""]}}], 
"0": [ "stream<AxiPackedStencil<unsigned int, 1, 1, 1, 1> >", {"hls_type": {"stream": [[[[],"6"]],"3"]}}], 
"6": [ "AxiPackedStencil<unsigned int, 1, 1, 1, 1>", {"struct": [[],[{"T":[[], {"scalar": "unsigned int"}]},{"EXTENT_0":[[], {"scalar": { "long unsigned int": 1}}]},{"EXTENT_1":[[], {"scalar": { "long unsigned int": 1}}]},{"EXTENT_2":[[], {"scalar": { "long unsigned int": 1}}]},{"EXTENT_3":[[], {"scalar": { "long unsigned int": 1}}]}],[{ "value": [[], "7"]},{ "last": [[], "5"]}],""]}], 
