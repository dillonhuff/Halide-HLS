...
set C_modelArgList {
	{ p_hw_input_stencil_stream_to_mul_V_value_V int 72 regular {fifo 0 volatile }  }
	{ p_mul_stencil_stream_V_value_V int 32 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "p_hw_input_stencil_stream_to_mul_V_value_V", "interface" : "fifo", "bitwidth" : 72, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ p_hw_input_stencil_stream_to_mul_V_value_V_dout sc_in sc_lv 72 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_hw_input_stencil_stream_to_mul_V_value_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":72, "type": "signal", "bundle":{"name": "p_hw_input_stencil_stream_to_mul_V_value_V", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	p_hw_input_stencil_stream_to_mul_V_value_V { ap_fifo {  { p_hw_input_stencil_stream_to_mul_V_value_V_dout fifo_data 0 72 }  { p_hw_input_stencil_stream_to_mul_V_value_V_empty_n fifo_status 0 1 }  { p_hw_input_stencil_stream_to_mul_V_value_V_read fifo_update 1 1 } } }
