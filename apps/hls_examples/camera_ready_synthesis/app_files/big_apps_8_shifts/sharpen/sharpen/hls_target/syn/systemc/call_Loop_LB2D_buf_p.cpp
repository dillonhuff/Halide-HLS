...
void call_Loop_LB2D_buf_p::thread_p_Val2_2_0_phi_fu_251_p3() {
    p_Val2_2_0_phi_fu_251_p3 = (!tmp_9_reg_340.read()[0].is_01())? sc_lv<8>(): ((tmp_9_reg_340.read()[0].to_bool())? buffer_1_value_V_lo_reg_334.read(): buffer_0_value_V_lo_reg_328.read());
}

void call_Loop_LB2D_buf_p::thread_p_Val2_2_1_phi_fu_256_p3() {
    p_Val2_2_1_phi_fu_256_p3 = (!tmp_9_reg_340.read()[0].is_01())? sc_lv<8>(): ((tmp_9_reg_340.read()[0].to_bool())? buffer_0_value_V_lo_reg_328.read(): buffer_1_value_V_lo_reg_334.read());
}
...
void call_Loop_LB2D_buf_p::thread_slice_stream_V_value_V_din() {
    slice_stream_V_value_V_din = esl_concat<16,8>(esl_concat<8,8>(tmp_value_V_2_reg_321.read(), p_Val2_2_1_phi_fu_256_p3.read()), p_Val2_2_0_phi_fu_251_p3.read());
}
