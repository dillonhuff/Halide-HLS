...
architecture behav of hls_target is 
    ...
    "hls_target,hls_ip_2017_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=5.600000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.332667,HLS_SYN_LAT=2077921,HLS_SYN_TPT=2077922,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=2202,HLS_SYN_LUT=1721}";
    ...
    signal Loop_1_proc_U0_p_hw_input_stencil_stream_to_delayed_input_V_value_V_din : STD_LOGIC_VECTOR (71 downto 0);
    signal Loop_1_proc_U0_p_hw_input_stencil_stream_to_delayed_input_V_value_V_write : STD_LOGIC;
    signal Loop_1_proc_U0_p_hw_input_stencil_stream_to_mul_V_value_V_din : STD_LOGIC_VECTOR (71 downto 0);
    signal Loop_1_proc_U0_p_hw_input_stencil_stream_to_mul_V_value_V_write : STD_LOGIC;
    ...
    signal Loop_2_proc_U0_p_hw_input_stencil_stream_to_delayed_input_V_value_V_read : STD_LOGIC;
    signal Loop_2_proc_U0_p_delayed_input_stencil_stream_V_value_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Loop_2_proc_U0_p_delayed_input_stencil_stream_V_value_V_write : STD_LOGIC;
    ...
    signal Loop_3_proc_U0_p_hw_input_stencil_stream_to_mul_V_value_V_read : STD_LOGIC;
    signal Loop_3_proc_U0_p_mul_stencil_stream_V_value_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Loop_3_proc_U0_p_mul_stencil_stream_V_value_V_write : STD_LOGIC;
    ...
    signal Loop_4_proc_U0_hw_output_V_value_V : STD_LOGIC_VECTOR (7 downto 0);
    signal Loop_4_proc_U0_hw_output_V_value_V_ap_vld : STD_LOGIC;
    signal Loop_4_proc_U0_hw_output_V_last_V : STD_LOGIC_VECTOR (0 downto 0);
    signal Loop_4_proc_U0_hw_output_V_last_V_ap_vld : STD_LOGIC;
    signal Loop_4_proc_U0_p_mul_stencil_stream_V_value_V_read : STD_LOGIC;
    signal Loop_4_proc_U0_p_delayed_input_stencil_stream_V_value_V_read : STD_LOGIC;
    ...
    signal p_hw_input_stencil_st_3_full_n : STD_LOGIC;
    signal p_hw_input_stencil_st_3_dout : STD_LOGIC_VECTOR (71 downto 0);
    signal p_hw_input_stencil_st_3_empty_n : STD_LOGIC;
    signal p_hw_input_stencil_st_4_full_n : STD_LOGIC;
    signal p_hw_input_stencil_st_4_dout : STD_LOGIC_VECTOR (71 downto 0);
    signal p_hw_input_stencil_st_4_empty_n : STD_LOGIC;
    signal p_delayed_input_stenc_full_n : STD_LOGIC;
    signal p_delayed_input_stenc_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal p_delayed_input_stenc_empty_n : STD_LOGIC;
    signal p_mul_stencil_stream_s_full_n : STD_LOGIC;
    signal p_mul_stencil_stream_s_dout : STD_LOGIC_VECTOR (31 downto 0);
    ...
    port (
        ...
        p_hw_input_stencil_stream_to_delayed_input_V_value_V_din : OUT STD_LOGIC_VECTOR (71 downto 0);
        ...
        p_hw_input_stencil_stream_to_mul_V_value_V_din : OUT STD_LOGIC_VECTOR (71 downto 0);
    ...
    component start_for_Loop_2_g8j IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_Loop_3_hbi IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_Loop_4_ibs IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    p_hw_input_stencil_st_3_U : component fifo_w72_d1_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    p_hw_input_stencil_st_4_U : component fifo_w72_d1_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    p_delayed_input_stenc_U : component fifo_w32_d1_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    p_mul_stencil_stream_s_U : component fifo_w32_d1_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Loop_2_g8j_U : component start_for_Loop_2_g8j
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Loop_3_hbi_U : component start_for_Loop_3_hbi
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Loop_4_ibs_U : component start_for_Loop_4_ibs
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    Loop_1_proc_U0_start_full_n <= (ap_const_logic_0 or start_for_Loop_2_proc_U0_full_n or start_for_Loop_3_proc_U0_full_n);
    Loop_2_proc_U0_ap_continue <= ap_const_logic_1;
    Loop_2_proc_U0_ap_start <= start_for_Loop_2_proc_U0_empty_n;
    Loop_2_proc_U0_start_full_n <= (ap_const_logic_0 or start_for_Loop_4_proc_U0_full_n);
    ...
    Loop_4_proc_U0_start_full_n <= ap_const_logic_0;
    Loop_4_proc_U0_start_write <= ap_const_logic_0;
    ap_done <= Loop_4_proc_U0_ap_done;
    ap_idle <= (linebuffer_1_U0_ap_idle and Loop_1_proc_U0_ap_idle and Loop_2_proc_U0_ap_idle and Loop_3_proc_U0_ap_idle and Loop_4_proc_U0_ap_idle);
    ap_ready <= linebuffer_1_U0_ap_ready;
