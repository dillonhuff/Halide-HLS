...
architecture behav of Loop_3_proc is 
    ...
    signal tmp_s_reg_231 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_reg_pp0_iter2_tmp_s_reg_231 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal p_s_fu_180_p4 : STD_LOGIC_VECTOR (4 downto 0);
...
begin
    ...
    hw_output_V_value_V <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_s_fu_180_p4),8));
    ...
    p_s_fu_180_p4 <= p_p2_mul1_stencil_stream_V_value_V_dout(7 downto 3);
    ...
    tmp_7_mid2_fu_175_p3 <= 
        ...
        ap_reg_pp0_iter2_tmp_s_reg_231;
    tmp_s_fu_152_p2 <= "1" when (p_hw_output_y_scan_1_phi_fu_95_p4 = ap_const_lv11_434) else "0";
end behav;
