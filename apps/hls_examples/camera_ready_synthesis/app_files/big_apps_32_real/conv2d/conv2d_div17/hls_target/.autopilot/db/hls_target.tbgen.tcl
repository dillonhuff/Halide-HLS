...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "13", "15", "16"],
		"CDFG" : "hls_target",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.linebuffer_1_U0", "Parent" : "0", "Child" : ["2", "3", "11", "12"],
		...
		"Port" : [
			...
			{"Name" : "out_stream_V_value_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "13", "DependentChan" : "15",
				"SubConnect" : [
	...
	{"ID" : "13", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Loop_1_proc_U0", "Parent" : "0", "Child" : ["14"],
		"CDFG" : "Loop_1_proc",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1",
		"Pipeline" : "None", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"Combinational" : "0",
		...
		"VariableLatency" : "1",
		"StartSource" : "1",
		"StartFifo" : "start_for_Loop_1_g8j_U",
		"Port" : [
			{"Name" : "p_hw_input_stencil_stream_V_value_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "8", "DependentChan" : "15",
				"BlockSignal" : [
	...
	{"ID" : "15", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_hw_input_stencil_st_U", "Parent" : "0"},
	{"ID" : "16", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_Loop_1_g8j_U", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	hls_target {
		...
		hw_output_V_value_V {Type O LastRead -1 FirstWrite 15}
		hw_output_V_last_V {Type O LastRead -1 FirstWrite 15}}
	linebuffer_1 {
