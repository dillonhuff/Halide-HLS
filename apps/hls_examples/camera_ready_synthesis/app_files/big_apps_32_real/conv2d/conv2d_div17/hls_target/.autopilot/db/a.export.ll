; ModuleID = '/home/dhuff/Halide-HLS/apps/hls_examples/camera_ready_synthesis/app_files/big_apps_32_real/conv2d/conv2d_div17/hls_target/.autopilot/db/a.o.2.bc'
...
entry:
  %empty = call i288 @llvm.part.select.i288(i288 %0, i32 %1, i32 %2)
  %empty_28 = trunc i288 %empty to i31
  ret i31 %empty_28
}
...
entry:
  %empty = call i288 @llvm.part.select.i288(i288 %0, i32 %1, i32 %2)
  %empty_29 = trunc i288 %empty to i30
  ret i30 %empty_29
}
...
entry:
  ...
  %empty_30 = trunc i65 %empty to i28
  ret i28 %empty_30
}
...
entry:
  ...
  %empty_44 = zext i2 %1 to i32
  %empty_45 = shl i32 %empty, 2
...
.preheader.preheader:                             ; preds = %.preheader
  ...
  %tmp_3 = call i31 @_ssdm_op_PartSelect.i31.i288.i32.i32(i288 %tmp_value_V, i32 32, i32 62)
  %p_353 = call i32 @_ssdm_op_BitConcatenate.i32.i31.i1(i31 %tmp_3, i1 false)
  %tmp_5 = call i31 @_ssdm_op_PartSelect.i31.i288.i32.i32(i288 %tmp_value_V, i32 96, i32 126)
  %p_365 = call i32 @_ssdm_op_BitConcatenate.i32.i31.i1(i31 %tmp_5, i1 false)
  %tmp_6 = call i30 @_ssdm_op_PartSelect.i30.i288.i32.i32(i288 %tmp_value_V, i32 128, i32 157)
  %p_371 = call i32 @_ssdm_op_BitConcatenate.i32.i30.i2(i30 %tmp_6, i2 0)
  %tmp_7 = call i31 @_ssdm_op_PartSelect.i31.i288.i32.i32(i288 %tmp_value_V, i32 160, i32 190)
  %p_377 = call i32 @_ssdm_op_BitConcatenate.i32.i31.i1(i31 %tmp_7, i1 false)
  %tmp_8 = call i31 @_ssdm_op_PartSelect.i31.i288.i32.i32(i288 %tmp_value_V, i32 224, i32 254)
  %p_389 = call i32 @_ssdm_op_BitConcatenate.i32.i31.i1(i31 %tmp_8, i1 false)
  %tmp8 = add i32 %p_389, %p_381
  %tmp9 = add i32 %p_371, %p_377
  %tmp7 = add i32 %tmp8, %tmp9
  %tmp1 = add i32 %p_353, %p_345
  %tmp2 = add i32 %p_393, %p_357
  %tmp3 = add i32 %p_365, %tmp2
  %tmp4 = add i32 %tmp1, %tmp3
  %p_397 = add nsw i32 %tmp7, %tmp4
  %sext_cast = sext i32 %p_397 to i65
  %mul = mul i65 8084644322, %sext_cast
  %neg_mul = sub i65 0, %mul
  %tmp = call i1 @_ssdm_op_BitSelect.i1.i32.i32(i32 %p_397, i32 31)
  %tmp_12 = call i28 @_ssdm_op_PartSelect.i28.i65.i32.i32(i65 %neg_mul, i32 37, i32 64)
  %tmp_9 = sext i28 %tmp_12 to i32
  %tmp_13 = call i28 @_ssdm_op_PartSelect.i28.i65.i32.i32(i65 %mul, i32 37, i32 64)
  %tmp_4 = sext i28 %tmp_13 to i32
  %tmp_10 = select i1 %tmp, i32 %tmp_9, i32 %tmp_4
  %neg_ti = sub i32 0, %tmp_10
  %p_399 = select i1 %tmp, i32 %neg_ti, i32 %tmp_4
  %tmp_14 = trunc i32 %p_399 to i28
  %tmp_15 = shl i32 %p_399, 4
  %p_neg = sub i32 0, %tmp_15
  %tmp_s = sub i32 %p_neg, %p_399
  %p_401 = add i32 %p_397, %tmp_s
  %tmp_16 = call i1 @_ssdm_op_BitSelect.i1.i32.i32(i32 %p_401, i32 31)
  %p_402_cast = select i1 %tmp_16, i28 -1, i28 0
  %p_408 = add i28 %p_402_cast, %tmp_14
  %tmp_value_V_4 = sext i28 %p_408 to i32
