...
#ifndef __hls_target_mul_34fYi__HH__
#define __hls_target_mul_34fYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hls_target_mul_34fYi) {
    ...
    SC_CTOR(hls_target_mul_34fYi):  ACMP_mul_us_U ("ACMP_mul_us_U") {
