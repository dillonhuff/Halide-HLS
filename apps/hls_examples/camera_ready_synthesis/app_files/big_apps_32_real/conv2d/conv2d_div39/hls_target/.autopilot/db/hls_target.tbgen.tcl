...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "13", "16", "17"],
		"CDFG" : "hls_target",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.linebuffer_1_U0", "Parent" : "0", "Child" : ["2", "3", "11", "12"],
		...
		"Port" : [
			...
			{"Name" : "out_stream_V_value_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "13", "DependentChan" : "16",
				"SubConnect" : [
	...
	{"ID" : "13", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Loop_1_proc_U0", "Parent" : "0", "Child" : ["14", "15"],
		"CDFG" : "Loop_1_proc",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1",
		"Pipeline" : "None", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"Combinational" : "0",
		...
		"Port" : [
			{"Name" : "p_hw_input_stencil_stream_V_value_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "8", "DependentChan" : "16",
				"BlockSignal" : [
	...
	{"ID" : "14", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Loop_1_proc_U0.hls_target_mul_34fYi_U18", "Parent" : "13"},
	{"ID" : "15", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Loop_1_proc_U0.hls_target_mul_7sg8j_U19", "Parent" : "13"},
	{"ID" : "16", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_hw_input_stencil_st_U", "Parent" : "0"},
	{"ID" : "17", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_Loop_1_hbi_U", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	hls_target {
		...
		hw_output_V_value_V {Type O LastRead -1 FirstWrite 20}
		hw_output_V_last_V {Type O LastRead -1 FirstWrite 20}}
	linebuffer_1 {
