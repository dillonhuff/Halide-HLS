...
#ifndef __hls_target_mul_7sg8j__HH__
#define __hls_target_mul_7sg8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hls_target_mul_7sg8j) {
    ...
    SC_CTOR(hls_target_mul_7sg8j):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
