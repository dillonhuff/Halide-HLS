...
architecture behav of linebuffer_2 is 
    ...
    signal linebuffer_Block_pr_U0_ap_start : STD_LOGIC;
    signal linebuffer_Block_pr_U0_ap_done : STD_LOGIC;
    signal linebuffer_Block_pr_U0_ap_continue : STD_LOGIC;
    signal linebuffer_Block_pr_U0_ap_idle : STD_LOGIC;
    signal linebuffer_Block_pr_U0_ap_ready : STD_LOGIC;
    signal linebuffer_Block_pr_U0_in_stream_V_value_V_read : STD_LOGIC;
    signal linebuffer_Block_pr_U0_out_stream_V_value_V_din : STD_LOGIC_VECTOR (127 downto 0);
    signal linebuffer_Block_pr_U0_out_stream_V_value_V_write : STD_LOGIC;
    signal ap_sync_continue : STD_LOGIC;
    signal ap_sync_done : STD_LOGIC;
    signal ap_sync_ready : STD_LOGIC;
    signal linebuffer_Block_pr_U0_start_full_n : STD_LOGIC;
    signal linebuffer_Block_pr_U0_start_write : STD_LOGIC;

    component linebuffer_Block_pr IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    linebuffer_Block_pr_U0 : component linebuffer_Block_pr
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    ap_sync_done <= linebuffer_Block_pr_U0_ap_done;
    ap_sync_ready <= linebuffer_Block_pr_U0_ap_ready;
    in_stream_V_value_V_read <= linebuffer_Block_pr_U0_in_stream_V_value_V_read;
    internal_ap_ready <= ap_sync_ready;
    linebuffer_Block_pr_U0_ap_continue <= ap_continue;
    linebuffer_Block_pr_U0_ap_start <= real_start;
