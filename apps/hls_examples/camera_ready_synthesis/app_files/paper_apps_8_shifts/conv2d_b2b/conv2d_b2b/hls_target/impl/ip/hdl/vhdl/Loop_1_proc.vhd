...
architecture behav of Loop_1_proc is 
    ...
    signal p_302_reg_363 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_reg_pp0_iter2_p_302_reg_363 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_reg_pp0_iter3_p_302_reg_363 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_252_fu_194_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal p_252_reg_368 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp1_fu_222_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp1_reg_373 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_3_reg_378 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_reg_pp0_iter2_tmp_3_reg_378 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_4_reg_383 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp4_fu_270_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp4_reg_388 : STD_LOGIC_VECTOR (8 downto 0);
    signal p_268_fu_282_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal p_268_reg_393 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp3_fu_302_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp3_reg_398 : STD_LOGIC_VECTOR (9 downto 0);
    signal p_300_fu_331_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal p_300_reg_403 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal p_238_fu_126_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_254_fu_134_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_286_fu_148_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_1_fu_172_p4 : STD_LOGIC_VECTOR (6 downto 0);
    signal p_250_fu_182_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_243_cast_fu_130_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal p_251_cast_fu_190_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_2_fu_200_p4 : STD_LOGIC_VECTOR (6 downto 0);
    signal p_266_fu_210_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_267_cast_cast_fu_218_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal p_259_cast_cast_fu_144_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_5_fu_248_p4 : STD_LOGIC_VECTOR (6 downto 0);
    signal p_298_fu_258_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_299_cast_cast_fu_266_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal p_291_cast_cast_fu_158_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal p_252_cast_fu_276_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp1_cast_fu_279_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal p_282_fu_288_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_283_cast_cast_fu_295_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp4_cast_fu_299_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal p_274_fu_311_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_275_cast_fu_318_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal p_268_cast_fu_308_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp2_fu_322_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp3_cast_fu_328_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal p_307_cast_fu_337_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal p_300_cast_fu_340_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal p_308_fu_343_p2 : STD_LOGIC_VECTOR (11 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (exitcond_flatten_reg_354 = ap_const_lv1_0) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then
                ...
                p_302_reg_363 <= p_hw_input_stencil_stream_V_value_V_dout(71 downto 64);
                tmp1_reg_373 <= tmp1_fu_222_p2;
                tmp4_reg_388 <= tmp4_fu_270_p2;
                tmp_3_reg_378 <= p_hw_input_stencil_stream_V_value_V_dout(37 downto 32);
                tmp_4_reg_383 <= p_hw_input_stencil_stream_V_value_V_dout(46 downto 40);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    p_238_fu_126_p1 <= p_hw_input_stencil_stream_V_value_V_dout(8 - 1 downto 0);
    p_243_cast_fu_130_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_238_fu_126_p1),9));
    p_250_fu_182_p3 <= (tmp_1_fu_172_p4 & ap_const_lv1_0);
    p_251_cast_fu_190_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_250_fu_182_p3),9));
    p_252_cast_fu_276_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_252_reg_368),10));
    p_252_fu_194_p2 <= std_logic_vector(unsigned(p_243_cast_fu_130_p1) + unsigned(p_251_cast_fu_190_p1));
    p_254_fu_134_p4 <= p_hw_input_stencil_stream_V_value_V_dout(23 downto 16);
    p_259_cast_cast_fu_144_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_254_fu_134_p4),9));
    p_266_fu_210_p3 <= (tmp_2_fu_200_p4 & ap_const_lv1_0);
    p_267_cast_cast_fu_218_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_266_fu_210_p3),9));
    p_268_cast_fu_308_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_268_reg_393),11));
    p_268_fu_282_p2 <= std_logic_vector(unsigned(p_252_cast_fu_276_p1) + unsigned(tmp1_cast_fu_279_p1));
    p_274_fu_311_p3 <= (ap_reg_pp0_iter2_tmp_3_reg_378 & ap_const_lv2_0);
    p_275_cast_fu_318_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_274_fu_311_p3),11));
    p_282_fu_288_p3 <= (tmp_4_reg_383 & ap_const_lv1_0);
    p_283_cast_cast_fu_295_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_282_fu_288_p3),10));
    p_286_fu_148_p4 <= p_hw_input_stencil_stream_V_value_V_dout(55 downto 48);
    p_291_cast_cast_fu_158_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_286_fu_148_p4),9));
    p_298_fu_258_p3 <= (tmp_5_fu_248_p4 & ap_const_lv1_0);
    p_299_cast_cast_fu_266_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_298_fu_258_p3),9));
    p_300_cast_fu_340_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_300_reg_403),12));
    p_300_fu_331_p2 <= std_logic_vector(unsigned(tmp2_fu_322_p2) + unsigned(tmp3_cast_fu_328_p1));
    p_307_cast_fu_337_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_reg_pp0_iter3_p_302_reg_363),12));
    p_308_fu_343_p2 <= std_logic_vector(unsigned(p_307_cast_fu_337_p1) + unsigned(p_300_cast_fu_340_p1));
    ...
    p_mul_stencil_update_stream_V_value_V_din <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_308_fu_343_p2),32));
    ...
    tmp1_fu_222_p2 <= std_logic_vector(unsigned(p_267_cast_cast_fu_218_p1) + unsigned(p_259_cast_cast_fu_144_p1));
    tmp2_fu_322_p2 <= std_logic_vector(unsigned(p_275_cast_fu_318_p1) + unsigned(p_268_cast_fu_308_p1));
    tmp3_cast_fu_328_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp3_reg_398),11));
    tmp3_fu_302_p2 <= std_logic_vector(unsigned(p_283_cast_cast_fu_295_p1) + unsigned(tmp4_cast_fu_299_p1));
    tmp4_cast_fu_299_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp4_reg_388),10));
    tmp4_fu_270_p2 <= std_logic_vector(unsigned(p_299_cast_cast_fu_266_p1) + unsigned(p_291_cast_cast_fu_158_p1));
    tmp_1_fu_172_p4 <= p_hw_input_stencil_stream_V_value_V_dout(14 downto 8);
    tmp_2_fu_200_p4 <= p_hw_input_stencil_stream_V_value_V_dout(30 downto 24);
    tmp_5_fu_248_p4 <= p_hw_input_stencil_stream_V_value_V_dout(62 downto 56);
end behav;
