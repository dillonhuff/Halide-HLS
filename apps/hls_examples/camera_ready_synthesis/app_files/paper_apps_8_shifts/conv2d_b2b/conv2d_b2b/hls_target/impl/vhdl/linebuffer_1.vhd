...
architecture behav of linebuffer_1 is 
    ...
    signal linebuffer_Loop_1_pr_U0_in_stream_V_value_V_din : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal linebuffer_U0_out_stream_V_value_V_din : STD_LOGIC_VECTOR (71 downto 0);
    ...
    signal in_stream_V_value_V_dout : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    in_stream_V_value_V_U : component fifo_w8_d1_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
