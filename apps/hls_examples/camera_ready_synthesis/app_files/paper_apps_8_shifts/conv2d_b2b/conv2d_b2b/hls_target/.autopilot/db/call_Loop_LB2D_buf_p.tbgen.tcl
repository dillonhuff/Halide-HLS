...
set C_modelArgList {
	{ in_stream_V_value_V int 8 regular {fifo 0 volatile }  }
	{ slice_stream_V_value_V int 24 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_stream_V_value_V", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "slice_stream_V_value_V", "interface" : "fifo", "bitwidth" : 24, "direction" : "WRITEONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_stream_V_value_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "in_stream_V_value_V", "role": "dout" }} , 
 	...
 	{ "name": "slice_stream_V_value_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "slice_stream_V_value_V", "role": "din" }} , 
...
set Spec2ImplPortList { 
	in_stream_V_value_V { ap_fifo {  { in_stream_V_value_V_dout fifo_data 0 8 }  { in_stream_V_value_V_empty_n fifo_status 0 1 }  { in_stream_V_value_V_read fifo_update 1 1 } } }
	slice_stream_V_value_V { ap_fifo {  { slice_stream_V_value_V_din fifo_data 1 24 }  { slice_stream_V_value_V_full_n fifo_status 0 1 }  { slice_stream_V_value_V_write fifo_update 1 1 } } }
}
