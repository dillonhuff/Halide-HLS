...
set C_modelArgList {
	{ slice_stream_V_value_V int 24 regular {fifo 0 volatile }  }
	{ out_stream_V_value_V int 72 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "slice_stream_V_value_V", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ slice_stream_V_value_V_dout sc_in sc_lv 24 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "slice_stream_V_value_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "slice_stream_V_value_V", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	slice_stream_V_value_V { ap_fifo {  { slice_stream_V_value_V_dout fifo_data 0 24 }  { slice_stream_V_value_V_empty_n fifo_status 0 1 }  { slice_stream_V_value_V_read fifo_update 1 1 } } }
