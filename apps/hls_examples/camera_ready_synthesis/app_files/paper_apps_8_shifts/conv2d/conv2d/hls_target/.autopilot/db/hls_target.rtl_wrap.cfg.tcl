...
set DataType0ta0 "unsigned char"
set structArgument0 [list $DataType0ta0 1 1 1 1 ]
set NameSpace0 [list ]
set structIsPacked0 "0"
set DataType0 [list "AxiPackedStencil<unsigned char, 1, 1, 1, 1>" "struct AxiPackedStencil" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
...
set DataType1ta0 "unsigned char"
set structArgument1 [list $DataType1ta0 1 1 1 1 ]
set NameSpace1 [list ]
set structIsPacked1 "0"
set DataType1 [list "AxiPackedStencil<unsigned char, 1, 1, 1, 1>" "struct AxiPackedStencil" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
