...
architecture behav of hls_target is 
    ...
    "hls_target,hls_ip_2017_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=5.600000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.935000,HLS_SYN_LAT=33,HLS_SYN_TPT=34,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=1521,HLS_SYN_LUT=1434}";
