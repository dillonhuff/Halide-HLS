; ModuleID = '/home/dhuff/Halide-HLS/apps/hls_examples/camera_ready_synthesis/app_files/paper_apps_8_shifts/sharpen/sharpen/hls_target/.autopilot/db/a.o.2.bc'
...
.preheader56:                                     ; preds = %.preheader
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 4, i64 4, i64 4)
  %exitcond6 = icmp eq i2 %p_hw_output_x_scan_2, -2
  %p_hw_output_x_scan_s = select i1 %exitcond6, i2 0, i2 %p_hw_output_x_scan_2
  %tmp_3_mid1 = icmp eq i2 %p_hw_output_y_scan_1, 0
  %tmp_1 = icmp eq i2 %p_hw_output_y_scan_1, 1
  %tmp_3_mid2 = select i1 %exitcond6, i1 %tmp_3_mid1, i1 %tmp_1
  %p_hw_output_y_scan_2 = add i2 1, %p_hw_output_y_scan_1
  %p_hw_output_y_scan_s = select i1 %exitcond6, i2 %p_hw_output_y_scan_2, i2 %p_hw_output_y_scan_1
  ...
  %p_435 = trunc i32 %tmp_value_V_5 to i8
  %p_s = call i4 @_ssdm_op_PartSelect.i4.i32.i32.i32(i32 %tmp_value_V_4, i32 4, i32 7)
  %p_438 = zext i4 %p_s to i8
  %p_443 = sub i8 %p_438, %p_435
  %p_439 = sub i8 %p_435, %p_438
  %tmp_12 = call i4 @_ssdm_op_PartSelect.i4.i8.i32.i32(i8 %p_439, i32 4, i32 7)
  %p_442 = icmp ne i4 %tmp_12, 0
  %tmp_13 = call i4 @_ssdm_op_PartSelect.i4.i8.i32.i32(i8 %p_443, i32 4, i32 7)
  %p_444 = icmp ne i4 %tmp_13, 0
  %tmp = call i6 @_ssdm_op_PartSelect.i6.i8.i32.i32(i8 %p_439, i32 2, i32 7)
  %tmp_14 = call i2 @_ssdm_op_PartSelect.i2.i8.i32.i32(i8 %p_439, i32 2, i32 3)
  %tmp_15 = select i1 %p_444, i2 %tmp_14, i2 0
  %tmp_5_cast = zext i2 %tmp_15 to i6
  %p_447 = select i1 %p_442, i6 %tmp, i6 %tmp_5_cast
  %p_447_cast = zext i6 %p_447 to i8
  %p_448 = add i8 %p_447_cast, %p_435
  %tmp_s = icmp eq i2 %p_hw_output_x_scan_s, 1
  %tmp_last_V = and i1 %tmp_s, %tmp_3_mid2
  call void @_ssdm_op_Write.ap_auto.volatile.i8P.i1P(i8* %hw_output_V_value_V, i1* %hw_output_V_last_V, i8 %p_448, i1 %tmp_last_V)
...
.preheader:                                       ; preds = %newFuncRoot, %.preheader56
  %indvar_flatten = phi i3 [ 0, %newFuncRoot ], [ %indvar_flatten_next, %.preheader56 ]
  %p_hw_output_y_scan_1 = phi i2 [ 0, %newFuncRoot ], [ %p_hw_output_y_scan_s, %.preheader56 ]
  %p_hw_output_x_scan_2 = phi i2 [ 0, %newFuncRoot ], [ %p_hw_output_x_scan_1, %.preheader56 ]
...
.preheader57.preheader:                           ; preds = %.preheader57
  ...
  %p_363 = trunc i72 %tmp_value_V to i8
  %p_368_cast = zext i8 %p_363 to i9
  %p_379 = call i8 @_ssdm_op_PartSelect.i8.i72.i32.i32(i72 %tmp_value_V, i32 16, i32 23)
  %p_384_cast_cast = zext i8 %p_379 to i9
  %p_411 = call i8 @_ssdm_op_PartSelect.i8.i72.i32.i32(i72 %tmp_value_V, i32 48, i32 55)
  %p_416_cast_cast = zext i8 %p_411 to i9
  %p_427 = call i8 @_ssdm_op_PartSelect.i8.i72.i32.i32(i72 %tmp_value_V, i32 64, i32 71)
  %p_432_cast = zext i8 %p_427 to i12
  %tmp_7 = call i7 @_ssdm_op_PartSelect.i7.i72.i32.i32(i72 %tmp_value_V, i32 8, i32 14)
  %p_375 = call i8 @_ssdm_op_BitConcatenate.i8.i7.i1(i7 %tmp_7, i1 false)
  %p_376_cast = zext i8 %p_375 to i9
  %p_377 = add i9 %p_368_cast, %p_376_cast
  %p_377_cast = zext i9 %p_377 to i10
  %tmp_8 = call i7 @_ssdm_op_PartSelect.i7.i72.i32.i32(i72 %tmp_value_V, i32 24, i32 30)
  %p_391 = call i8 @_ssdm_op_BitConcatenate.i8.i7.i1(i7 %tmp_8, i1 false)
  %p_392_cast_cast = zext i8 %p_391 to i9
  %tmp = add i9 %p_392_cast_cast, %p_384_cast_cast
  %tmp_cast = zext i9 %tmp to i10
  %p_393 = add i10 %p_377_cast, %tmp_cast
  %p_393_cast = zext i10 %p_393 to i11
  %tmp_9 = call i6 @_ssdm_op_PartSelect.i6.i72.i32.i32(i72 %tmp_value_V, i32 32, i32 37)
  %p_399 = call i8 @_ssdm_op_BitConcatenate.i8.i6.i2(i6 %tmp_9, i2 0)
  %p_400_cast = zext i8 %p_399 to i11
  %tmp_s = call i7 @_ssdm_op_PartSelect.i7.i72.i32.i32(i72 %tmp_value_V, i32 40, i32 46)
  %p_407 = call i8 @_ssdm_op_BitConcatenate.i8.i7.i1(i7 %tmp_s, i1 false)
  %p_408_cast_cast = zext i8 %p_407 to i10
  %tmp_3 = call i7 @_ssdm_op_PartSelect.i7.i72.i32.i32(i72 %tmp_value_V, i32 56, i32 62)
  %p_423 = call i8 @_ssdm_op_BitConcatenate.i8.i7.i1(i7 %tmp_3, i1 false)
  %p_424_cast_cast = zext i8 %p_423 to i9
  %tmp1 = add i11 %p_400_cast, %p_393_cast
  %tmp3 = add i9 %p_424_cast_cast, %p_416_cast_cast
  %tmp3_cast = zext i9 %tmp3 to i10
  %tmp2 = add i10 %p_408_cast_cast, %tmp3_cast
  %tmp2_cast = zext i10 %tmp2 to i11
  %p_425 = add i11 %tmp1, %tmp2_cast
  %p_425_cast = zext i11 %p_425 to i12
  %p_433 = add i12 %p_432_cast, %p_425_cast
  %tmp_value_V_7 = zext i12 %p_433 to i32
...
.preheader57:                                     ; preds = %newFuncRoot, %.preheader57.preheader
  %indvar_flatten = phi i3 [ 0, %newFuncRoot ], [ %indvar_flatten_next, %.preheader57.preheader ]
  %exitcond_flatten = icmp eq i3 %indvar_flatten, -4
  %indvar_flatten_next = add i3 %indvar_flatten, 1
...
.preheader58.preheader:                           ; preds = %.preheader58
  ...
  %p_355 = call i8 @_ssdm_op_PartSelect.i8.i72.i32.i32(i72 %tmp_value_V, i32 64, i32 71)
  %p_360 = zext i8 %p_355 to i32
  call void @_ssdm_op_Write.ap_fifo.volatile.i32P(i32* %p_delayed_input_stencil_stream_V_value_V, i32 %p_360)
  %empty_88 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str4, i32 %tmp_1)
  br label %.preheader58

.preheader58:                                     ; preds = %newFuncRoot, %.preheader58.preheader
  %indvar_flatten = phi i3 [ 0, %newFuncRoot ], [ %indvar_flatten_next, %.preheader58.preheader ]
  %exitcond_flatten = icmp eq i3 %indvar_flatten, -4
  %indvar_flatten_next = add i3 %indvar_flatten, 1
...
.preheader59:                                     ; preds = %newFuncRoot, %.preheader59.preheader
  %indvar_flatten = phi i3 [ 0, %newFuncRoot ], [ %indvar_flatten_next, %.preheader59.preheader ]
  %exitcond_flatten = icmp eq i3 %indvar_flatten, -4
  %indvar_flatten_next = add i3 %indvar_flatten, 1
