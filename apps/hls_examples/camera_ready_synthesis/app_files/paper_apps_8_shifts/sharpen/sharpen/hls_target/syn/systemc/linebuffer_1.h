...
struct linebuffer_1 : public sc_module {
    ...
    sc_in< sc_lv<8> > in_axi_stream_V_value_V;
    ...
    sc_signal< sc_lv<8> > linebuffer_Loop_1_pr_U0_in_stream_V_value_V_din;
    ...
    sc_signal< sc_lv<72> > linebuffer_U0_out_stream_V_value_V_din;
    ...
    sc_signal< sc_lv<8> > in_stream_V_value_V_dout;
