; ModuleID = '/home/dhuff/Halide-HLS/apps/hls_examples/camera_ready_synthesis/app_files/paper_apps_8_shifts/sharpen/sharpen/hls_target/.autopilot/db/a.o.3.bc'
...
.preheader:                                       ; preds = %"linebuffer_1D<4ul, 3ul, 1ul, 1ul, 1ul, 3ul, unsigned char>.exit", %newFuncRoot
  ...
  %tmp_1 = icmp eq i2 %n1, -2, !dbg !3403         ; [#uses=1 type=i1] [debug line = 216:31]
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 2, i64 2, i64 2) ; [#uses=0 type=i32]
  %n1_1 = add i2 %n1, 1, !dbg !3410               ; [#uses=1 type=i2] [debug line = 216:55]
...
"linebuffer_1D<4ul, 3ul, 1ul, 1ul, 1ul, 3ul, unsigned char>.exit": ; preds = %0
  ...
  call void @llvm.dbg.value(metadata !{i2 %n1_1}, i64 0, metadata !3413), !dbg !3410 ; [debug line = 216:55] [debug variable = n1]
...
; <label>:0                                       ; preds = %._crit_edge.i.i, %1
  ...
  %tmp_3 = icmp eq i3 %i_0_i_i, -4, !dbg !3414    ; [#uses=1 type=i1] [debug line = 32:33@143:2@217:9]
  %empty_26 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 4, i64 4, i64 4) ; [#uses=0 type=i32]
  %i = add i3 %i_0_i_i, 1, !dbg !3420             ; [#uses=1 type=i3] [debug line = 32:53@143:2@217:9]
  br i1 %tmp_3, label %"linebuffer_1D<4ul, 3ul, 1ul, 1ul, 1ul, 3ul, unsigned char>.exit", label %2, !dbg !3414 ; [debug line = 32:33@143:2@217:9]
...
._crit_edge.i.i:                                  ; preds = %.preheader.i.i.preheader.0, %2
  ...
  call void @llvm.dbg.value(metadata !{i3 %i}, i64 0, metadata !3448) nounwind, !dbg !3420 ; [debug line = 32:53@143:2@217:9] [debug variable = i]
...
; <label>:2                                       ; preds = %0
  ...
  %tmp = call i2 @_ssdm_op_PartSelect.i2.i3.i32.i32(i3 %i_0_i_i, i32 1, i32 2), !dbg !3461 ; [#uses=1 type=i2] [debug line = 42:9@143:2@217:9]
  %icmp = icmp eq i2 %tmp, 0, !dbg !3461          ; [#uses=1 type=i1] [debug line = 42:9@143:2@217:9]
...
newFuncRoot:
  ...
  call void @llvm.dbg.declare(metadata !{[4 x i8]* %buffer_0_value_V}, metadata !3499), !dbg !3506 ; [debug line = 168:68] [debug variable = buffer[0].value.V]
  %buffer_1_value_V = alloca [4 x i8], align 1    ; [#uses=1 type=[4 x i8]*]
  call void @llvm.dbg.declare(metadata !{[4 x i8]* %buffer_1_value_V}, metadata !3507), !dbg !3506 ; [debug line = 168:68] [debug variable = buffer[1].value.V]
  br label %0
...
; <label>:0                                       ; preds = %1, %newFuncRoot
  ...
  %tmp = icmp eq i3 %row, -4, !dbg !3508          ; [#uses=1 type=i1] [debug line = 177:30]
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 4, i64 4, i64 4) ; [#uses=0 type=i32]
  %row_1 = add i3 %row, 1, !dbg !3510             ; [#uses=1 type=i3] [debug line = 177:52]
...
; <label>:1                                       ; preds = %2
  ...
  call void @llvm.dbg.value(metadata !{i3 %row_1}, i64 0, metadata !3515), !dbg !3510 ; [debug line = 177:52] [debug variable = row]
...
; <label>:2                                       ; preds = %._crit_edge31, %3
  ...
  %tmp_2 = icmp eq i3 %col, -4, !dbg !3516        ; [#uses=1 type=i1] [debug line = 179:21]
  %col_1 = add i3 %col, 1, !dbg !3518             ; [#uses=1 type=i3] [debug line = 179:43]
...
; <label>:3                                       ; preds = %0
  ...
  %tmp_6 = call i2 @_ssdm_op_PartSelect.i2.i3.i32.i32(i3 %row, i32 1, i32 2), !dbg !3520 ; [#uses=1 type=i2] [debug line = 187:13]
  %icmp = icmp eq i2 %tmp_6, 0, !dbg !3520        ; [#uses=1 type=i1] [debug line = 187:13]
...
._crit_edge31:                                    ; preds = %branch5, %branch4
  ...
  call void @llvm.dbg.value(metadata !{i3 %col_1}, i64 0, metadata !3523), !dbg !3518 ; [debug line = 179:43] [debug variable = col]
...
; <label>:4                                       ; preds = %2
  %col_cast = zext i3 %col to i64, !dbg !3516     ; [#uses=2 type=i64] [debug line = 179:21]
...
entry:
  ...
  %empty_41 = trunc i3 %empty to i2               ; [#uses=1 type=i2]
  ret i2 %empty_41
}
...
.preheader56:                                     ; preds = %.preheader
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 4, i64 4, i64 4) ; [#uses=0 type=i32]
  %exitcond6 = icmp eq i2 %p_hw_output_x_scan_2, -2, !dbg !3614 ; [#uses=3 type=i1] [debug line = 301:41]
  %p_hw_output_x_scan_s = select i1 %exitcond6, i2 0, i2 %p_hw_output_x_scan_2 ; [#uses=2 type=i2]
  %tmp_3_mid1 = icmp eq i2 %p_hw_output_y_scan_1, 0, !dbg !3618 ; [#uses=1 type=i1] [debug line = 334:4]
  %tmp_1 = icmp eq i2 %p_hw_output_y_scan_1, 1, !dbg !3618 ; [#uses=1 type=i1] [debug line = 334:4]
  %tmp_3_mid2 = select i1 %exitcond6, i1 %tmp_3_mid1, i1 %tmp_1, !dbg !3618 ; [#uses=1 type=i1] [debug line = 334:4]
  %p_hw_output_y_scan_2 = add i2 1, %p_hw_output_y_scan_1, !dbg !3620 ; [#uses=1 type=i2] [debug line = 299:77]
  %p_hw_output_y_scan_s = select i1 %exitcond6, i2 %p_hw_output_y_scan_2, i2 %p_hw_output_y_scan_1 ; [#uses=1 type=i2]
  ...
  call void @llvm.dbg.value(metadata !{i32 %tmp_value_V_5}, i64 0, metadata !3631), !dbg !3634 ; [debug line = 317:17] [debug variable = _434]
  %p_435 = trunc i32 %tmp_value_V_5 to i8, !dbg !3635 ; [#uses=3 type=i8] [debug line = 318:34]
  call void @llvm.dbg.value(metadata !{i8 %p_435}, i64 0, metadata !3636), !dbg !3635 ; [debug line = 318:34] [debug variable = _435]
  call void @llvm.dbg.value(metadata !{i32 %tmp_value_V_4}, i64 0, metadata !3639), !dbg !3640 ; [debug line = 319:19] [debug variable = _436]
  %p_s = call i4 @_ssdm_op_PartSelect.i4.i32.i32.i32(i32 %tmp_value_V_4, i32 4, i32 7), !dbg !3641 ; [#uses=1 type=i4] [debug line = 321:28]
  %p_438 = zext i4 %p_s to i8, !dbg !3641         ; [#uses=2 type=i8] [debug line = 321:28]
  %p_443 = sub i8 %p_438, %p_435, !dbg !3642      ; [#uses=1 type=i8] [debug line = 326:30]
  %p_439 = sub i8 %p_435, %p_438, !dbg !3643      ; [#uses=3 type=i8] [debug line = 322:30]
  call void @llvm.dbg.value(metadata !{i8 %p_438}, i64 0, metadata !3644), !dbg !3641 ; [debug line = 321:28] [debug variable = _438]
  call void @llvm.dbg.value(metadata !{i8 %p_439}, i64 0, metadata !3645), !dbg !3643 ; [debug line = 322:30] [debug variable = _439]
  %tmp_12 = call i4 @_ssdm_op_PartSelect.i4.i8.i32.i32(i8 %p_439, i32 4, i32 7), !dbg !3646 ; [#uses=1 type=i4] [debug line = 325:27]
  %p_442 = icmp ne i4 %tmp_12, 0, !dbg !3646      ; [#uses=1 type=i1] [debug line = 325:27]
  call void @llvm.dbg.value(metadata !{i1 %p_442}, i64 0, metadata !3647), !dbg !3646 ; [debug line = 325:27] [debug variable = _442]
  call void @llvm.dbg.value(metadata !{i8 %p_443}, i64 0, metadata !3648), !dbg !3642 ; [debug line = 326:30] [debug variable = _443]
  %tmp_13 = call i4 @_ssdm_op_PartSelect.i4.i8.i32.i32(i8 %p_443, i32 4, i32 7), !dbg !3649 ; [#uses=1 type=i4] [debug line = 327:27]
  %p_444 = icmp ne i4 %tmp_13, 0, !dbg !3649      ; [#uses=1 type=i1] [debug line = 327:27]
  call void @llvm.dbg.value(metadata !{i1 %p_444}, i64 0, metadata !3650), !dbg !3649 ; [debug line = 327:27] [debug variable = _444]
  %tmp = call i6 @_ssdm_op_PartSelect.i6.i8.i32.i32(i8 %p_439, i32 2, i32 7), !dbg !3651 ; [#uses=1 type=i6] [debug line = 330:28]
  %tmp_14 = call i2 @_ssdm_op_PartSelect.i2.i8.i32.i32(i8 %p_439, i32 2, i32 3), !dbg !3652 ; [#uses=1 type=i2] [debug line = 329:48]
  %tmp_15 = select i1 %p_444, i2 %tmp_14, i2 0, !dbg !3653 ; [#uses=1 type=i2] [debug line = 328:28]
  %tmp_5_cast = zext i2 %tmp_15 to i6, !dbg !3652 ; [#uses=1 type=i6] [debug line = 329:48]
  %p_447 = select i1 %p_442, i6 %tmp, i6 %tmp_5_cast, !dbg !3652 ; [#uses=1 type=i6] [debug line = 329:48]
  %p_447_cast = zext i6 %p_447 to i8, !dbg !3652  ; [#uses=1 type=i8] [debug line = 329:48]
  call void @llvm.dbg.value(metadata !{i6 %p_447}, i64 0, metadata !3654), !dbg !3651 ; [debug line = 330:28] [debug variable = _447]
  %p_448 = add i8 %p_447_cast, %p_435, !dbg !3655 ; [#uses=1 type=i8] [debug line = 331:30]
  call void @llvm.dbg.value(metadata !{i8 %p_448}, i64 0, metadata !3656), !dbg !3655 ; [debug line = 331:30] [debug variable = _448]
  call void @llvm.dbg.value(metadata !{i8 %p_448}, i64 0, metadata !3657) nounwind, !dbg !3677 ; [debug line = 34:28@196:30@205:65@333:64] [debug variable = in]
  call void @llvm.dbg.value(metadata !{i8 %p_448}, i64 0, metadata !3678), !dbg !3680 ; [debug line = 957:248@197:13@205:65@333:64] [debug variable = res.value.V]
  %tmp_s = icmp eq i2 %p_hw_output_x_scan_s, 1, !dbg !3618 ; [#uses=1 type=i1] [debug line = 334:4]
  %tmp_last_V = and i1 %tmp_s, %tmp_3_mid2, !dbg !3618 ; [#uses=1 type=i1] [debug line = 334:4]
  ...
  call void @llvm.dbg.value(metadata !{i8 %p_448}, i64 0, metadata !3691), !dbg !3694 ; [debug line = 145:31@339:4] [debug variable = tmp.value.V]
  ...
  call void @_ssdm_op_Write.ap_auto.volatile.i8P.i1P(i8* %hw_output_V_value_V, i1* %hw_output_V_last_V, i8 %p_448, i1 %tmp_last_V), !dbg !3696 ; [debug line = 146:9@339:4]
  %empty_86 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str7, i32 %tmp_4), !dbg !3697 ; [#uses=0 type=i32] [debug line = 341:3]
  %p_hw_output_x_scan_1 = add i2 1, %p_hw_output_x_scan_s, !dbg !3698 ; [#uses=1 type=i2] [debug line = 301:78]
  call void @llvm.dbg.value(metadata !{i2 %p_hw_output_x_scan_1}, i64 0, metadata !3699), !dbg !3698 ; [debug line = 301:78] [debug variable = _hw_output_x___scan_dim_0]
  br label %.preheader, !dbg !3698                ; [debug line = 301:78]

.preheader:                                       ; preds = %.preheader56, %newFuncRoot
  %indvar_flatten = phi i3 [ 0, %newFuncRoot ], [ %indvar_flatten_next, %.preheader56 ] ; [#uses=2 type=i3]
  %p_hw_output_y_scan_1 = phi i2 [ 0, %newFuncRoot ], [ %p_hw_output_y_scan_s, %.preheader56 ] ; [#uses=4 type=i2]
  %p_hw_output_x_scan_2 = phi i2 [ 0, %newFuncRoot ], [ %p_hw_output_x_scan_1, %.preheader56 ] ; [#uses=2 type=i2]
...
.preheader57.preheader:                           ; preds = %.preheader57
  ...
  %p_363 = trunc i72 %tmp_value_V to i8, !dbg !3713 ; [#uses=1 type=i8] [debug line = 940:93@1483:19@199:102@199:103@122:32@203:22]
  %p_368_cast = zext i8 %p_363 to i9, !dbg !3739  ; [#uses=1 type=i9] [debug line = 215:34]
  %p_379 = call i8 @_ssdm_op_PartSelect.i8.i72.i32.i32(i72 %tmp_value_V, i32 16, i32 23), !dbg !3713 ; [#uses=1 type=i8] [debug line = 940:93@1483:19@199:102@199:103@122:32@203:22]
  %p_384_cast_cast = zext i8 %p_379 to i9, !dbg !3713 ; [#uses=1 type=i9] [debug line = 940:93@1483:19@199:102@199:103@122:32@203:22]
  %p_411 = call i8 @_ssdm_op_PartSelect.i8.i72.i32.i32(i72 %tmp_value_V, i32 48, i32 55), !dbg !3713 ; [#uses=1 type=i8] [debug line = 940:93@1483:19@199:102@199:103@122:32@203:22]
  %p_416_cast_cast = zext i8 %p_411 to i9, !dbg !3713 ; [#uses=1 type=i9] [debug line = 940:93@1483:19@199:102@199:103@122:32@203:22]
  %p_427 = call i8 @_ssdm_op_PartSelect.i8.i72.i32.i32(i72 %tmp_value_V, i32 64, i32 71), !dbg !3713 ; [#uses=1 type=i8] [debug line = 940:93@1483:19@199:102@199:103@122:32@203:22]
  %p_432_cast = zext i8 %p_427 to i12, !dbg !3740 ; [#uses=1 type=i12] [debug line = 287:34]
  call void @llvm.dbg.value(metadata !{i8 %p_363}, i64 0, metadata !3741), !dbg !3742 ; [debug line = 210:19] [debug variable = _363]
  call void @llvm.dbg.value(metadata !{i8 %p_363}, i64 0, metadata !3743), !dbg !3744 ; [debug line = 214:34] [debug variable = _367]
  %tmp_7 = call i7 @_ssdm_op_PartSelect.i7.i72.i32.i32(i72 %tmp_value_V, i32 8, i32 14) ; [#uses=1 type=i7]
  %p_375 = call i8 @_ssdm_op_BitConcatenate.i8.i7.i1(i7 %tmp_7, i1 false), !dbg !3745 ; [#uses=1 type=i8] [debug line = 223:34]
  %p_376_cast = zext i8 %p_375 to i9, !dbg !3746  ; [#uses=1 type=i9] [debug line = 224:34]
  %p_377 = add i9 %p_368_cast, %p_376_cast, !dbg !3747 ; [#uses=1 type=i9] [debug line = 225:30]
  %p_377_cast = zext i9 %p_377 to i10, !dbg !3747 ; [#uses=1 type=i10] [debug line = 225:30]
  call void @llvm.dbg.value(metadata !{i8 %p_375}, i64 0, metadata !3748), !dbg !3745 ; [debug line = 223:34] [debug variable = _375]
  call void @llvm.dbg.value(metadata !{i9 %p_377}, i64 0, metadata !3749), !dbg !3747 ; [debug line = 225:30] [debug variable = _377]
  call void @llvm.dbg.value(metadata !{i9 %p_377}, i64 0, metadata !3750), !dbg !3751 ; [debug line = 227:19] [debug variable = _378]
  call void @llvm.dbg.value(metadata !{i8 %p_379}, i64 0, metadata !3752), !dbg !3753 ; [debug line = 228:19] [debug variable = _379]
  call void @llvm.dbg.value(metadata !{i8 %p_379}, i64 0, metadata !3754), !dbg !3755 ; [debug line = 232:34] [debug variable = _383]
  %tmp_8 = call i7 @_ssdm_op_PartSelect.i7.i72.i32.i32(i72 %tmp_value_V, i32 24, i32 30) ; [#uses=1 type=i7]
  %p_391 = call i8 @_ssdm_op_BitConcatenate.i8.i7.i1(i7 %tmp_8, i1 false), !dbg !3756 ; [#uses=1 type=i8] [debug line = 241:34]
  %p_392_cast_cast = zext i8 %p_391 to i9, !dbg !3757 ; [#uses=1 type=i9] [debug line = 243:30]
  %tmp = add i9 %p_392_cast_cast, %p_384_cast_cast, !dbg !3757 ; [#uses=1 type=i9] [debug line = 243:30]
  %tmp_cast = zext i9 %tmp to i10, !dbg !3757     ; [#uses=1 type=i10] [debug line = 243:30]
  %p_393 = add i10 %p_377_cast, %tmp_cast, !dbg !3757 ; [#uses=1 type=i10] [debug line = 243:30]
  %p_393_cast = zext i10 %p_393 to i11, !dbg !3757 ; [#uses=1 type=i11] [debug line = 243:30]
  call void @llvm.dbg.value(metadata !{i8 %p_391}, i64 0, metadata !3758), !dbg !3756 ; [debug line = 241:34] [debug variable = _391]
  call void @llvm.dbg.value(metadata !{i10 %p_393}, i64 0, metadata !3759), !dbg !3757 ; [debug line = 243:30] [debug variable = _393]
  call void @llvm.dbg.value(metadata !{i10 %p_393}, i64 0, metadata !3760), !dbg !3761 ; [debug line = 245:19] [debug variable = _394]
  %tmp_9 = call i6 @_ssdm_op_PartSelect.i6.i72.i32.i32(i72 %tmp_value_V, i32 32, i32 37) ; [#uses=1 type=i6]
  %p_399 = call i8 @_ssdm_op_BitConcatenate.i8.i6.i2(i6 %tmp_9, i2 0), !dbg !3762 ; [#uses=1 type=i8] [debug line = 250:34]
  %p_400_cast = zext i8 %p_399 to i11, !dbg !3763 ; [#uses=1 type=i11] [debug line = 251:34]
  call void @llvm.dbg.value(metadata !{i8 %p_399}, i64 0, metadata !3764), !dbg !3762 ; [debug line = 250:34] [debug variable = _399]
  %tmp_s = call i7 @_ssdm_op_PartSelect.i7.i72.i32.i32(i72 %tmp_value_V, i32 40, i32 46) ; [#uses=1 type=i7]
  %p_407 = call i8 @_ssdm_op_BitConcatenate.i8.i7.i1(i7 %tmp_s, i1 false), !dbg !3765 ; [#uses=1 type=i8] [debug line = 259:34]
  %p_408_cast_cast = zext i8 %p_407 to i10, !dbg !3765 ; [#uses=1 type=i10] [debug line = 259:34]
  call void @llvm.dbg.value(metadata !{i8 %p_407}, i64 0, metadata !3766), !dbg !3765 ; [debug line = 259:34] [debug variable = _407]
  call void @llvm.dbg.value(metadata !{i8 %p_411}, i64 0, metadata !3767), !dbg !3768 ; [debug line = 264:19] [debug variable = _411]
  call void @llvm.dbg.value(metadata !{i8 %p_411}, i64 0, metadata !3769), !dbg !3770 ; [debug line = 268:34] [debug variable = _415]
  %tmp_3 = call i7 @_ssdm_op_PartSelect.i7.i72.i32.i32(i72 %tmp_value_V, i32 56, i32 62) ; [#uses=1 type=i7]
  %p_423 = call i8 @_ssdm_op_BitConcatenate.i8.i7.i1(i7 %tmp_3, i1 false), !dbg !3771 ; [#uses=1 type=i8] [debug line = 277:34]
  %p_424_cast_cast = zext i8 %p_423 to i9, !dbg !3772 ; [#uses=1 type=i9] [debug line = 279:30]
  %tmp1 = add i11 %p_400_cast, %p_393_cast, !dbg !3772 ; [#uses=1 type=i11] [debug line = 279:30]
  %tmp3 = add i9 %p_424_cast_cast, %p_416_cast_cast, !dbg !3772 ; [#uses=1 type=i9] [debug line = 279:30]
  %tmp3_cast = zext i9 %tmp3 to i10, !dbg !3772   ; [#uses=1 type=i10] [debug line = 279:30]
  %tmp2 = add i10 %p_408_cast_cast, %tmp3_cast, !dbg !3772 ; [#uses=1 type=i10] [debug line = 279:30]
  %tmp2_cast = zext i10 %tmp2 to i11, !dbg !3772  ; [#uses=1 type=i11] [debug line = 279:30]
  %p_425 = add i11 %tmp1, %tmp2_cast, !dbg !3772  ; [#uses=1 type=i11] [debug line = 279:30]
  %p_425_cast = zext i11 %p_425 to i12, !dbg !3772 ; [#uses=1 type=i12] [debug line = 279:30]
  %p_433 = add i12 %p_432_cast, %p_425_cast, !dbg !3773 ; [#uses=1 type=i12] [debug line = 288:30]
  %tmp_value_V_7 = zext i12 %p_433 to i32, !dbg !3773 ; [#uses=1 type=i32] [debug line = 288:30]
  call void @llvm.dbg.value(metadata !{i8 %p_423}, i64 0, metadata !3774), !dbg !3771 ; [debug line = 277:34] [debug variable = _423]
  call void @llvm.dbg.value(metadata !{i11 %p_425}, i64 0, metadata !3775), !dbg !3772 ; [debug line = 279:30] [debug variable = _425]
  call void @llvm.dbg.value(metadata !{i11 %p_425}, i64 0, metadata !3776), !dbg !3777 ; [debug line = 281:19] [debug variable = _426]
  call void @llvm.dbg.value(metadata !{i8 %p_427}, i64 0, metadata !3778), !dbg !3779 ; [debug line = 282:19] [debug variable = _427]
  call void @llvm.dbg.value(metadata !{i8 %p_427}, i64 0, metadata !3780), !dbg !3781 ; [debug line = 286:34] [debug variable = _431]
  call void @llvm.dbg.value(metadata !{i12 %p_433}, i64 0, metadata !3782), !dbg !3773 ; [debug line = 288:30] [debug variable = _433]
  call void @llvm.dbg.value(metadata !{i12 %p_433}, i64 0, metadata !3783) nounwind, !dbg !3800 ; [debug line = 34:28@196:30@290:30] [debug variable = in]
  call void @llvm.dbg.value(metadata !{i12 %p_433}, i64 0, metadata !3801), !dbg !3803 ; [debug line = 957:248@197:13@290:30] [debug variable = res.value.V]
  call void @llvm.dbg.value(metadata !{i12 %p_433}, i64 0, metadata !3810), !dbg !3814 ; [debug line = 145:31@290:30] [debug variable = tmp.value.V]
  ...
  br label %.preheader57, !dbg !3817              ; [debug line = 197:66]

.preheader57:                                     ; preds = %.preheader57.preheader, %newFuncRoot
  %indvar_flatten = phi i3 [ 0, %newFuncRoot ], [ %indvar_flatten_next, %.preheader57.preheader ] ; [#uses=2 type=i3]
  %exitcond_flatten = icmp eq i3 %indvar_flatten, -4 ; [#uses=1 type=i1]
  %indvar_flatten_next = add i3 %indvar_flatten, 1 ; [#uses=1 type=i3]
...
.preheader58.preheader:                           ; preds = %.preheader58
  ...
  %p_355 = call i8 @_ssdm_op_PartSelect.i8.i72.i32.i32(i72 %tmp_value_V, i32 64, i32 71), !dbg !3827 ; [#uses=1 type=i8] [debug line = 940:93@1483:19@199:102@199:103@122:32@95:22]
  %p_360 = zext i8 %p_355 to i32, !dbg !3832      ; [#uses=1 type=i32] [debug line = 179:34]
  call void @llvm.dbg.value(metadata !{i8 %p_355}, i64 0, metadata !3833), !dbg !3834 ; [debug line = 174:19] [debug variable = _355]
  call void @llvm.dbg.value(metadata !{i8 %p_355}, i64 0, metadata !3835), !dbg !3836 ; [debug line = 178:34] [debug variable = _359]
  call void @llvm.dbg.value(metadata !{i32 %p_360}, i64 0, metadata !3837), !dbg !3832 ; [debug line = 179:34] [debug variable = _360]
  call void @llvm.dbg.value(metadata !{i32 %p_360}, i64 0, metadata !3838), !dbg !3839 ; [debug line = 180:30] [debug variable = _361]
  call void @llvm.dbg.value(metadata !{i32 %p_360}, i64 0, metadata !3840) nounwind, !dbg !3843 ; [debug line = 34:28@196:30@182:40] [debug variable = in]
  call void @llvm.dbg.value(metadata !{i32 %p_360}, i64 0, metadata !3801), !dbg !3844 ; [debug line = 957:248@197:13@182:40] [debug variable = res.value.V]
  call void @llvm.dbg.value(metadata !{i32 %p_360}, i64 0, metadata !3810), !dbg !3846 ; [debug line = 145:31@182:40] [debug variable = tmp.value.V]
  call void @_ssdm_op_Write.ap_fifo.volatile.i32P(i32* %p_delayed_input_stencil_stream_V_value_V, i32 %p_360), !dbg !3847 ; [debug line = 146:9@182:40]
  %empty_88 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str4, i32 %tmp_1), !dbg !3848 ; [#uses=0 type=i32] [debug line = 184:3]
  br label %.preheader58, !dbg !3849              ; [debug line = 89:86]

.preheader58:                                     ; preds = %.preheader58.preheader, %newFuncRoot
  %indvar_flatten = phi i3 [ 0, %newFuncRoot ], [ %indvar_flatten_next, %.preheader58.preheader ] ; [#uses=2 type=i3]
  %exitcond_flatten = icmp eq i3 %indvar_flatten, -4 ; [#uses=1 type=i1]
  %indvar_flatten_next = add i3 %indvar_flatten, 1 ; [#uses=1 type=i3]
...
.preheader59.preheader:                           ; preds = %.preheader59
  ...
  br label %.preheader59, !dbg !3872              ; [debug line = 68:36]

.preheader59:                                     ; preds = %.preheader59.preheader, %newFuncRoot
  %indvar_flatten = phi i3 [ 0, %newFuncRoot ], [ %indvar_flatten_next, %.preheader59.preheader ] ; [#uses=2 type=i3]
  %exitcond_flatten = icmp eq i3 %indvar_flatten, -4 ; [#uses=1 type=i1]
  %indvar_flatten_next = add i3 %indvar_flatten, 1 ; [#uses=1 type=i3]
...
!113 = metadata !{i32 786478, i32 0, metadata !114, metadata !"linebuffer<4, 4, 1, 1, 1, 1, 1, 1, 3, 3, 1, 1, unsigned char>", metadata !"linebuffer<4, 4, 1, 1, 1, 1, 1, 1, 3, 3, 1, 1, unsigned char>", metadata !"_Z10linebufferILm4ELm4ELm1ELm1ELm1ELm1ELm1ELm1ELm3ELm3ELm1ELm1EhEvRN3hls6streamI16AxiPackedStencilIT11_XT3_EXT4_EXT5_EXT6_EEEERNS1_I13PackedStencilIS3_XT7_EXT8_EXT9_EXT10_EEEE", metadata !114, i32 537, metadata !115, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, metadata !2164, null, metadata !144, i32 538} ; [ DW_TAG_subprogram ]
!114 = metadata !{i32 786473, metadata !"../../../lib_files/Linebuffer.h", metadata !"/home/dhuff/Halide-HLS/apps/hls_examples/camera_ready_synthesis/app_files/paper_apps_8_shifts/sharpen", null} ; [ DW_TAG_file_type ]
...
!120 = metadata !{i32 786473, metadata !"/cad/xilinx/vivado/2017.2/Vivado_HLS/2017.2/common/technology/autopilot/hls_stream.h", metadata !"/home/dhuff/Halide-HLS/apps/hls_examples/camera_ready_synthesis/app_files/paper_apps_8_shifts/sharpen", null} ; [ DW_TAG_file_type ]
...
!124 = metadata !{i32 786473, metadata !"../../../lib_files/Stencil.h", metadata !"/home/dhuff/Halide-HLS/apps/hls_examples/camera_ready_synthesis/app_files/paper_apps_8_shifts/sharpen", null} ; [ DW_TAG_file_type ]
...
!128 = metadata !{i32 786473, metadata !"/cad/xilinx/vivado/2017.2/Vivado_HLS/2017.2/common/technology/autopilot/ap_int.h", metadata !"/home/dhuff/Halide-HLS/apps/hls_examples/camera_ready_synthesis/app_files/paper_apps_8_shifts/sharpen", null} ; [ DW_TAG_file_type ]
...
!132 = metadata !{i32 786473, metadata !"/cad/xilinx/vivado/2017.2/Vivado_HLS/2017.2/common/technology/autopilot/ap_int_syn.h", metadata !"/home/dhuff/Halide-HLS/apps/hls_examples/camera_ready_synthesis/app_files/paper_apps_8_shifts/sharpen", null} ; [ DW_TAG_file_type ]
...
!136 = metadata !{i32 786473, metadata !"/cad/xilinx/vivado/2017.2/Vivado_HLS/2017.2/common/technology/autopilot/etc/autopilot_dt.def", metadata !"/home/dhuff/Halide-HLS/apps/hls_examples/camera_ready_synthesis/app_files/paper_apps_8_shifts/sharpen", null} ; [ DW_TAG_file_type ]
...
!2165 = metadata !{i32 786480, null, metadata !"IMG_EXTENT_0", metadata !207, i64 4, null, i32 0, i32 0} ; [ DW_TAG_template_value_parameter ]
!2166 = metadata !{i32 786480, null, metadata !"IMG_EXTENT_1", metadata !207, i64 4, null, i32 0, i32 0} ; [ DW_TAG_template_value_parameter ]
...
!2299 = metadata !{i32 786478, i32 0, metadata !114, metadata !"linebuffer<4, 4, 1, 1, 1, 1, 1, 1, 3, 3, 1, 1, unsigned char>", metadata !"linebuffer<4, 4, 1, 1, 1, 1, 1, 1, 3, 3, 1, 1, unsigned char>", metadata !"_Z10linebufferILm4ELm4ELm1ELm1ELm1ELm1ELm1ELm1ELm3ELm3ELm1ELm1EhEvRN3hls6streamI13PackedStencilIT11_XT3_EXT4_EXT5_EXT6_EEEERNS1_IS2_IS3_XT7_EXT8_EXT9_EXT10_EEEE", metadata !114, i32 525, metadata !2300, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, metadata !2164, null, metadata !144, i32 526} ; [ DW_TAG_subprogram ]
...
!2313 = metadata !{i32 786478, i32 0, metadata !114, metadata !"linebuffer_3D<4, 4, 1, 1, 1, 3, 3, 1, 1, unsigned char>", metadata !"linebuffer_3D<4, 4, 1, 1, 1, 3, 3, 1, 1, unsigned char>", metadata !"_Z13linebuffer_3DILm4ELm4ELm1ELm1ELm1ELm3ELm3ELm1ELm1EhEvRN3hls6streamI13PackedStencilIT8_XT2_EXT3_EXT6_EXT7_EEEERNS1_IS2_IS3_XT4_EXT5_EXT6_EXT7_EEEE", metadata !114, i32 488, metadata !2300, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, metadata !2314, null, metadata !144, i32 489} ; [ DW_TAG_subprogram ]
...
!2338 = metadata !{i32 786478, i32 0, metadata !114, metadata !"linebuffer_2D<4, 4, 1, 1, 1, 1, 3, 3, unsigned char>", metadata !"linebuffer_2D<4, 4, 1, 1, 1, 1, 3, 3, unsigned char>", metadata !"_Z13linebuffer_2DILm4ELm4ELm1ELm1ELm1ELm1ELm3ELm3EhEvRN3hls6streamI13PackedStencilIT7_XT3_EXT4_EXT1_EXT2_EEEERNS1_IS2_IS3_XT5_EXT6_EXT1_EXT2_EEEE", metadata !114, i32 400, metadata !2300, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, metadata !2339, null, metadata !144, i32 401} ; [ DW_TAG_subprogram ]
...
!2351 = metadata !{i32 786473, metadata !"hls_target.cpp", metadata !"/home/dhuff/Halide-HLS/apps/hls_examples/camera_ready_synthesis/app_files/paper_apps_8_shifts/sharpen", null} ; [ DW_TAG_file_type ]
...
!3388 = metadata !{i32 786478, i32 0, metadata !3389, metadata !"call", metadata !"call", metadata !"_ZN12Linebuffer1DILm4ELm3ELm1ELm1ELm1ELm3EhE4callERN3hls6streamI13PackedStencilIhLm1ELm3ELm1ELm1EEEERNS2_IS3_IhLm3ELm3ELm1ELm1EEEE", metadata !114, i32 17, metadata !3221, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !144, i32 17} ; [ DW_TAG_subprogram ]
!3389 = metadata !{i32 786434, null, metadata !"Linebuffer1D<4, 3, 1, 1, 1, 3, unsigned char>", metadata !114, i32 15, i64 8, i64 8, i32 0, i32 0, null, metadata !3390, i32 0, null, metadata !3391} ; [ DW_TAG_class_type ]
...
!3407 = metadata !{i32 786478, i32 0, metadata !3408, metadata !"call", metadata !"call", metadata !"_ZN12Linebuffer2DILm4ELm4ELm1ELm1ELm1ELm1ELm3ELm3EhE4callERN3hls6streamI13PackedStencilIhLm1ELm1ELm1ELm1EEEERNS2_IS3_IhLm3ELm3ELm1ELm1EEEE", metadata !114, i32 152, metadata !2300, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !144, i32 152} ; [ DW_TAG_subprogram ]
!3408 = metadata !{i32 786434, null, metadata !"Linebuffer2D<4, 4, 1, 1, 1, 1, 3, 3, unsigned char>", metadata !114, i32 150, i64 8, i64 8, i32 0, i32 0, null, metadata !3409, i32 0, null, metadata !2339} ; [ DW_TAG_class_type ]
...
!3418 = metadata !{i32 786478, i32 0, metadata !114, metadata !"linebuffer_1D<4, 3, 1, 1, 1, 3, unsigned char>", metadata !"linebuffer_1D<4, 3, 1, 1, 1, 3, unsigned char>", metadata !"_Z13linebuffer_1DILm4ELm3ELm1ELm1ELm1ELm3EhEvRN3hls6streamI13PackedStencilIT5_XT3_EXT0_EXT1_EXT2_EEEERNS1_IS2_IS3_XT4_EXT0_EXT1_EXT2_EEEE", metadata !114, i32 140, metadata !3221, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, metadata !3391, null, metadata !144, i32 141} ; [ DW_TAG_subprogram ]
...
!3501 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 64, i64 8, i32 0, i32 0, metadata !1197, metadata !3502, i32 0, i32 0} ; [ DW_TAG_array_type ]
!3502 = metadata !{metadata !3503, metadata !3504}
!3503 = metadata !{i32 786465, i64 0, i64 1}      ; [ DW_TAG_subrange_type ]
!3504 = metadata !{i32 786465, i64 0, i64 3}      ; [ DW_TAG_subrange_type ]
!3505 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 32, i64 8, i32 0, i32 0, metadata !2263, metadata !3502, i32 0, i32 0} ; [ DW_TAG_array_type ]
...
!3618 = metadata !{i32 334, i32 4, metadata !3619, null}
!3619 = metadata !{i32 786443, metadata !3615, i32 302, i32 3, metadata !2351, i32 17} ; [ DW_TAG_lexical_block ]
!3620 = metadata !{i32 299, i32 77, metadata !3617, null}
!3621 = metadata !{i32 302, i32 4, metadata !3619, null}
!3622 = metadata !{i32 303, i32 1, metadata !3619, null}
...
!3626 = metadata !{i32 307, i32 17, metadata !3619, null}
...
!3630 = metadata !{i32 312, i32 27, metadata !3619, null}
!3631 = metadata !{i32 786688, metadata !3619, metadata !"_434", metadata !2351, i32 317, metadata !3632, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!3634 = metadata !{i32 317, i32 17, metadata !3619, null}
!3635 = metadata !{i32 318, i32 34, metadata !3619, null}
!3636 = metadata !{i32 786688, metadata !3619, metadata !"_435", metadata !2351, i32 318, metadata !3637, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!3639 = metadata !{i32 786688, metadata !3619, metadata !"_436", metadata !2351, i32 319, metadata !3632, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3640 = metadata !{i32 319, i32 19, metadata !3619, null}
!3641 = metadata !{i32 321, i32 28, metadata !3619, null}
!3642 = metadata !{i32 326, i32 30, metadata !3619, null}
!3643 = metadata !{i32 322, i32 30, metadata !3619, null}
!3644 = metadata !{i32 786688, metadata !3619, metadata !"_438", metadata !2351, i32 321, metadata !3637, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3645 = metadata !{i32 786688, metadata !3619, metadata !"_439", metadata !2351, i32 322, metadata !3637, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3646 = metadata !{i32 325, i32 27, metadata !3619, null}
!3647 = metadata !{i32 786688, metadata !3619, metadata !"_442", metadata !2351, i32 325, metadata !155, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3648 = metadata !{i32 786688, metadata !3619, metadata !"_443", metadata !2351, i32 326, metadata !3637, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3649 = metadata !{i32 327, i32 27, metadata !3619, null}
!3650 = metadata !{i32 786688, metadata !3619, metadata !"_444", metadata !2351, i32 327, metadata !155, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3651 = metadata !{i32 330, i32 28, metadata !3619, null}
!3652 = metadata !{i32 329, i32 48, metadata !3619, null}
!3653 = metadata !{i32 328, i32 28, metadata !3619, null}
!3654 = metadata !{i32 786688, metadata !3619, metadata !"_447", metadata !2351, i32 330, metadata !3637, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3655 = metadata !{i32 331, i32 30, metadata !3619, null}
!3656 = metadata !{i32 786688, metadata !3619, metadata !"_448", metadata !2351, i32 331, metadata !3637, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!3676 = metadata !{i32 333, i32 64, metadata !3619, null}
...
!3689 = metadata !{i32 339, i32 4, metadata !3619, null}
...
!3697 = metadata !{i32 341, i32 3, metadata !3619, null}
!3698 = metadata !{i32 301, i32 78, metadata !3615, null}
...
!3741 = metadata !{i32 786688, metadata !3703, metadata !"_363", metadata !2351, i32 210, metadata !3637, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3742 = metadata !{i32 210, i32 19, metadata !3703, null}
!3743 = metadata !{i32 786688, metadata !3703, metadata !"_367", metadata !2351, i32 214, metadata !3637, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!3748 = metadata !{i32 786688, metadata !3703, metadata !"_375", metadata !2351, i32 223, metadata !3637, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3749 = metadata !{i32 786688, metadata !3703, metadata !"_377", metadata !2351, i32 225, metadata !3632, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3750 = metadata !{i32 786688, metadata !3703, metadata !"_378", metadata !2351, i32 227, metadata !3632, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3751 = metadata !{i32 227, i32 19, metadata !3703, null}
!3752 = metadata !{i32 786688, metadata !3703, metadata !"_379", metadata !2351, i32 228, metadata !3637, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3753 = metadata !{i32 228, i32 19, metadata !3703, null}
!3754 = metadata !{i32 786688, metadata !3703, metadata !"_383", metadata !2351, i32 232, metadata !3637, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!3758 = metadata !{i32 786688, metadata !3703, metadata !"_391", metadata !2351, i32 241, metadata !3637, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3759 = metadata !{i32 786688, metadata !3703, metadata !"_393", metadata !2351, i32 243, metadata !3632, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3760 = metadata !{i32 786688, metadata !3703, metadata !"_394", metadata !2351, i32 245, metadata !3632, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!3764 = metadata !{i32 786688, metadata !3703, metadata !"_399", metadata !2351, i32 250, metadata !3637, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3765 = metadata !{i32 259, i32 34, metadata !3703, null}
!3766 = metadata !{i32 786688, metadata !3703, metadata !"_407", metadata !2351, i32 259, metadata !3637, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3767 = metadata !{i32 786688, metadata !3703, metadata !"_411", metadata !2351, i32 264, metadata !3637, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3768 = metadata !{i32 264, i32 19, metadata !3703, null}
!3769 = metadata !{i32 786688, metadata !3703, metadata !"_415", metadata !2351, i32 268, metadata !3637, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!3774 = metadata !{i32 786688, metadata !3703, metadata !"_423", metadata !2351, i32 277, metadata !3637, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3775 = metadata !{i32 786688, metadata !3703, metadata !"_425", metadata !2351, i32 279, metadata !3632, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3776 = metadata !{i32 786688, metadata !3703, metadata !"_426", metadata !2351, i32 281, metadata !3632, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3777 = metadata !{i32 281, i32 19, metadata !3703, null}
!3778 = metadata !{i32 786688, metadata !3703, metadata !"_427", metadata !2351, i32 282, metadata !3637, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3779 = metadata !{i32 282, i32 19, metadata !3703, null}
!3780 = metadata !{i32 786688, metadata !3703, metadata !"_431", metadata !2351, i32 286, metadata !3637, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3781 = metadata !{i32 286, i32 34, metadata !3703, null}
!3782 = metadata !{i32 786688, metadata !3703, metadata !"_433", metadata !2351, i32 288, metadata !3632, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!3817 = metadata !{i32 197, i32 66, metadata !3704, null}
...
!3833 = metadata !{i32 786688, metadata !3821, metadata !"_355", metadata !2351, i32 174, metadata !3637, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3834 = metadata !{i32 174, i32 19, metadata !3821, null}
!3835 = metadata !{i32 786688, metadata !3821, metadata !"_359", metadata !2351, i32 178, metadata !3637, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3836 = metadata !{i32 178, i32 34, metadata !3821, null}
!3837 = metadata !{i32 786688, metadata !3821, metadata !"_360", metadata !2351, i32 179, metadata !3632, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3838 = metadata !{i32 786688, metadata !3821, metadata !"_361", metadata !2351, i32 180, metadata !3632, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!3849 = metadata !{i32 89, i32 86, metadata !3822, null}
...
!3872 = metadata !{i32 68, i32 36, metadata !3860, null}
