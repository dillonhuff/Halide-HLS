...
set C_modelArgList {
	{ in_axi_stream_V_value_V int 8 regular {pointer 0 volatile }  }
	{ in_axi_stream_V_last_V int 1 regular {pointer 0 volatile }  }
	{ out_stream_V_value_V int 72 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_axi_stream_V_value_V", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "in_axi_stream_V_last_V", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "out_stream_V_value_V", "interface" : "fifo", "bitwidth" : 72, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ in_axi_stream_V_value_V sc_in sc_lv 8 signal 0 } 
	{ in_axi_stream_V_last_V sc_in sc_lv 1 signal 1 } 
	{ out_stream_V_value_V_din sc_out sc_lv 72 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_start", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "start", "bundle":{"name": "ap_start", "role": "default" }} , 
 	...
 	{ "name": "in_axi_stream_V_value_V", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "in_axi_stream_V_value_V", "role": "default" }} , 
 	...
 	{ "name": "out_stream_V_value_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":72, "type": "signal", "bundle":{"name": "out_stream_V_value_V", "role": "din" }} , 
...
set Spec2ImplPortList { 
	in_axi_stream_V_value_V { ap_hs {  { in_axi_stream_V_value_V in_data 0 8 }  { in_axi_stream_V_value_V_ap_vld in_vld 0 1 }  { in_axi_stream_V_value_V_ap_ack in_acc 1 1 } } }
	...
	out_stream_V_value_V { ap_fifo {  { out_stream_V_value_V_din fifo_data 1 72 }  { out_stream_V_value_V_full_n fifo_status 0 1 }  { out_stream_V_value_V_write fifo_update 1 1 } } }
}
