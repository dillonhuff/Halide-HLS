...
architecture behav of Loop_1_proc is 
    ...
    signal tmp_5_reg_316 : STD_LOGIC_VECTOR (30 downto 0);
    signal tmp_6_reg_321 : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_reg_pp0_iter2_tmp_6_reg_321 : STD_LOGIC_VECTOR (30 downto 0);
    signal tmp_7_reg_326 : STD_LOGIC_VECTOR (29 downto 0);
    signal tmp_8_reg_331 : STD_LOGIC_VECTOR (30 downto 0);
    signal tmp_9_reg_336 : STD_LOGIC_VECTOR (30 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (exitcond_flatten_reg_287 = ap_const_lv1_0) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then
                ...
                tmp_5_reg_316 <= p_hw_input_stencil_stream_V_value_V_dout(62 downto 32);
                tmp_6_reg_321 <= p_hw_input_stencil_stream_V_value_V_dout(126 downto 96);
                tmp_7_reg_326 <= p_hw_input_stencil_stream_V_value_V_dout(157 downto 128);
                tmp_8_reg_331 <= p_hw_input_stencil_stream_V_value_V_dout(190 downto 160);
                tmp_9_reg_336 <= p_hw_input_stencil_stream_V_value_V_dout(254 downto 224);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    p_336_fu_212_p3 <= (tmp_5_reg_316 & ap_const_lv1_0);
    p_348_fu_261_p3 <= (ap_reg_pp0_iter2_tmp_6_reg_321 & ap_const_lv1_0);
    p_354_fu_219_p3 <= (tmp_7_reg_326 & ap_const_lv2_0);
    p_360_fu_226_p3 <= (tmp_8_reg_331 & ap_const_lv1_0);
    p_372_fu_233_p3 <= (tmp_9_reg_336 & ap_const_lv1_0);
