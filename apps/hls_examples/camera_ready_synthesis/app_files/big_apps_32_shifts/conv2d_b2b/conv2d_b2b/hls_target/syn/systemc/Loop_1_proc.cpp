...
Loop_1_proc::Loop_1_proc(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( tmp_5_reg_316 );

    SC_METHOD(thread_p_348_fu_261_p3);
    sensitive << ( ap_reg_pp0_iter2_tmp_6_reg_321 );

    SC_METHOD(thread_p_354_fu_219_p3);
    sensitive << ( tmp_7_reg_326 );

    SC_METHOD(thread_p_360_fu_226_p3);
    sensitive << ( tmp_8_reg_331 );

    SC_METHOD(thread_p_372_fu_233_p3);
    sensitive << ( tmp_9_reg_336 );
    ...
    sc_trace(mVcdFile, tmp_5_reg_316, "tmp_5_reg_316");
    sc_trace(mVcdFile, tmp_6_reg_321, "tmp_6_reg_321");
    sc_trace(mVcdFile, ap_reg_pp0_iter2_tmp_6_reg_321, "ap_reg_pp0_iter2_tmp_6_reg_321");
    sc_trace(mVcdFile, tmp_7_reg_326, "tmp_7_reg_326");
    sc_trace(mVcdFile, tmp_8_reg_331, "tmp_8_reg_331");
    sc_trace(mVcdFile, tmp_9_reg_336, "tmp_9_reg_336");
...
void Loop_1_proc::thread_ap_clk_no_reset_() {
    ...
    if (esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00011001.read(), ap_const_boolean_0)) {
        ...
        ap_reg_pp0_iter2_tmp_6_reg_321 = tmp_6_reg_321.read();
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(exitcond_flatten_reg_287.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00011001.read(), ap_const_boolean_0))) {
        ...
        tmp_5_reg_316 = p_hw_input_stencil_stream_V_value_V_dout.read().range(62, 32);
        tmp_6_reg_321 = p_hw_input_stencil_stream_V_value_V_dout.read().range(126, 96);
        tmp_7_reg_326 = p_hw_input_stencil_stream_V_value_V_dout.read().range(157, 128);
        tmp_8_reg_331 = p_hw_input_stencil_stream_V_value_V_dout.read().range(190, 160);
        tmp_9_reg_336 = p_hw_input_stencil_stream_V_value_V_dout.read().range(254, 224);
    }
...
void Loop_1_proc::thread_p_336_fu_212_p3() {
    p_336_fu_212_p3 = esl_concat<31,1>(tmp_5_reg_316.read(), ap_const_lv1_0);
}

void Loop_1_proc::thread_p_348_fu_261_p3() {
    p_348_fu_261_p3 = esl_concat<31,1>(ap_reg_pp0_iter2_tmp_6_reg_321.read(), ap_const_lv1_0);
}

void Loop_1_proc::thread_p_354_fu_219_p3() {
    p_354_fu_219_p3 = esl_concat<30,2>(tmp_7_reg_326.read(), ap_const_lv2_0);
}

void Loop_1_proc::thread_p_360_fu_226_p3() {
    p_360_fu_226_p3 = esl_concat<31,1>(tmp_8_reg_331.read(), ap_const_lv1_0);
}

void Loop_1_proc::thread_p_372_fu_233_p3() {
    p_372_fu_233_p3 = esl_concat<31,1>(tmp_9_reg_336.read(), ap_const_lv1_0);
}
