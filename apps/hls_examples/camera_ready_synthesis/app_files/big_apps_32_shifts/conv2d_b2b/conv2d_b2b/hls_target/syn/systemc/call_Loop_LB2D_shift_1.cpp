...
void call_Loop_LB2D_shift_1::thread_out_stream_V_value_V_din() {
    out_stream_V_value_V_din = esl_concat<96,32>(esl_concat<64,32>(esl_concat<32,32>(p_Result_11_1_1_fu_152_p4.read(), p_Result_11_1_fu_142_p4.read()), tmp_1_fu_138_p1.read()), tmp_fu_134_p1.read());
}
