...
struct Loop_1_proc : public sc_module {
    ...
    sc_signal< sc_lv<31> > tmp_5_reg_316;
    sc_signal< sc_lv<31> > tmp_6_reg_321;
    sc_signal< sc_lv<31> > ap_reg_pp0_iter2_tmp_6_reg_321;
    sc_signal< sc_lv<30> > tmp_7_reg_326;
    sc_signal< sc_lv<31> > tmp_8_reg_331;
    sc_signal< sc_lv<31> > tmp_9_reg_336;
