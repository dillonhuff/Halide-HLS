...
architecture behav of hls_target is 
    ...
    signal Loop_1_proc_U0_p_hw_input_stencil_stream_to_delayed_input_V_value_V_din : STD_LOGIC_VECTOR (287 downto 0);
    signal Loop_1_proc_U0_p_hw_input_stencil_stream_to_delayed_input_V_value_V_write : STD_LOGIC;
    signal Loop_1_proc_U0_p_hw_input_stencil_stream_to_mul_V_value_V_din : STD_LOGIC_VECTOR (287 downto 0);
    ...
    signal Loop_4_proc_U0_hw_output_V_value_V : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal p_hw_input_stencil_st_3_dout : STD_LOGIC_VECTOR (287 downto 0);
    signal p_hw_input_stencil_st_3_empty_n : STD_LOGIC;
    signal p_hw_input_stencil_st_4_full_n : STD_LOGIC;
    signal p_hw_input_stencil_st_4_dout : STD_LOGIC_VECTOR (287 downto 0);
...
begin
    ...
    p_hw_input_stencil_st_3_U : component fifo_w288_d1_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    p_hw_input_stencil_st_4_U : component fifo_w288_d1_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    p_delayed_input_stenc_U : component fifo_w32_d1_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    p_mul_stencil_stream_s_U : component fifo_w32_d1_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
