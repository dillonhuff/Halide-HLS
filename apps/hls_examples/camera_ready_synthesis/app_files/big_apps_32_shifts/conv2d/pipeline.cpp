...
public:
          ...
          win(0, 3, 0, 3)
    {
      ...
      kernel(0, 0) = cast<uint32_t>(0);
      kernel(1, 0) = cast<uint32_t>(1);
      kernel(2, 0) = cast<uint32_t>(0);

      kernel(0, 1) = cast<uint32_t>(1);
      kernel(1, 1) = cast<uint32_t>(2);
      kernel(2, 1) = cast<uint32_t>(1);

      kernel(0, 2) = cast<uint32_t>(0);
      kernel(1, 2) = cast<uint32_t>(1);
      kernel(2, 2) = cast<uint32_t>(0);
